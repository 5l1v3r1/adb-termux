...
wget https://raw.githubusercontent.com/ShuBhamg0sain/adb-server/main/bin/adb -P $downpath/ -q
echo -e "\e[32m[*] \e[34mDownloading binaries..."
wget https://raw.githubusercontent.com/ShuBhamg0sain/adb-termux/main/bin/adb.bin -P $downpath/ -q
wget https://raw.githubusercontent.com/ShuBhamg0sain/adb-termux/main/bin/fastboot -P $downpath/ -q
wget https://raw.githubusercontent.com/ShuBhamg0sain/adb-termux/main/bin/fastboot-armeabi -P $downpath/ -q
